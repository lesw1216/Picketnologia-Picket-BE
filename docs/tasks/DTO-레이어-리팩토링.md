...
> 생성일: 2026-05-22
> 브랜치: refactor/dto-layer-restructure

## Tasks

- [ ] Task 0. 규칙 문서 보강 (dto-layer.md, dto-create.md) ~~진행중~~
- [ ] Task 1. user 도메인 - Read → Result 리네임
- [ ] Task 2. token 도메인 - 응답 DTO 네이밍·위치 정리
- [ ] Task 3. product 도메인 - Read → Result 리네임 및 위치 정리
